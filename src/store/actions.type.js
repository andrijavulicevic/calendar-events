...
export const LOAD_PENDING_EVENTS = "loadPendingEvents";
...
export const ACCEPT_EVENT_INVITE = "acceptEventInvite";
export const DECLINE_EVENT_INVITE = "declineEventInvite";
